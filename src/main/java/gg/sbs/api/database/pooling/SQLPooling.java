package gg.sbs.api.database.pooling;

import gg.sbs.api.database.factory.SQLFactory;
...
public abstract class SQLPooling extends SQLFactory {
	 ...
	 */
	public final Connection getConnection(WaitTime waitTime) throws SQLException {
