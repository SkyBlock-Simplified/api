...
public final class HypixelGuild {
	...
	public class Member {
		...
		public Rank getRank() {
			return HypixelGuild.this.ranks.stream().filter(rank -> rank.getName().equals(this.rank) || ("Admin".equals(rank.getName()) && "Guild Master".equals(this.rank))).collect(ListUtil.toSingleton());
		}
