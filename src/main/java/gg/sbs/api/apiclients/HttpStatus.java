...
public enum HttpStatus {
	...
	CLOUDFLARE_WEB_SERVER_UNKNOWN_ERROR(520, "CloudFlare: Web Server Returns An Unknown Error"),
	CLOUDFLARE_WEB_SERVER_DOWN(521, "CloudFlare: Web Server Is Down"),
	CLOUDFLARE_CONNECTION_TIMED_OUT(522, "CloudFlare: Connection Timed Out"),
	CLOUDFLARE_ORIGIN_IS_UNREACHABLE(523, "CloudFlare: Origin Is Unreachable"),
	CLOUDFLARE_A_TIME_OUT_OCCURRED(524, "CloudFlare: A Timeout Occurred"),
	CLOUDFLARE_SSL_HANDSHAKE_FAILED(525, "CloudFlare: SSL Handshake Failed"),
	CLOUDFLARE_INVALID_SSL_CERTIFICATE(526, "CloudFlare: Invalid SSL Certificate"),
	CLOUDFLARE_RAILGUN_LISTENER_TO_ORIGIN_ERROR(527, "CloudFlare: Railgun Listener To Origin Error"),
	CLOUDFLARE_GENERIC_ERROR(530, "CloudFlare: CloudFlare Generic Error"),
