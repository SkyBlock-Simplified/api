...
public enum MenuItem {
	...
	CRAFTING_TABLE_RESULT("Blocks.BARRIER", "§cRecipe Required", null),
	GO_BACK("Items.ARROW", "§aGo Back"),
	QUIVER_ARROW("Items.ARROW", "§8Quiver Arrow"),
	CLOSE("Blocks.BARRIER", "§cClose");

	private final String item;
	private final String itemName;
	private final Skyblock.InventoryType inventoryType;

	MenuItem(String item, String itemName) {
		this(item, itemName, null);
	}

	MenuItem(String item, String itemName, Skyblock.InventoryType inventoryType) {
		this.item = item;
