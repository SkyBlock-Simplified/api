...
public class StringBuilder implements CharSequence, Appendable, Serializable, Builder<String> {
    ...
    class StringBuilderReader extends Reader {
        ...
        public int read() {
            ...
            return StringBuilder.this.charAt(pos++);
        }
        ...
        public int read(final char[] b, final int off, int len) {
            ...
            if (pos >= StringBuilder.this.size()) {
                return -1;
            }
            if (pos + len > size()) {
                len = StringBuilder.this.size() - pos;
            }
        ...
        public boolean ready() {
            return pos < StringBuilder.this.size();
        }
        ...
        public long skip(long n) {
            if (pos + n > StringBuilder.this.size()) {
                n = StringBuilder.this.size() - pos;
            }
            if (n < 0) {
                return 0;
            }
     ...
     * @since 1.9
     */
    public static StringBuilder wrap(final char[] initialBuffer) {
     ...
     * @since 1.9
     */
    public static StringBuilder wrap(final char[] initialBuffer, final int length) {
        return new StringBuilder(initialBuffer, length);
    }
     ...
     */
    private StringBuilder(final char[] initialBuffer, final int length) {
    ...
    public StringBuilder(final CharSequence seq) {
        this(StringUtil.length(seq) + CAPACITY);
        if (seq != null) {
            append(seq);
        }
    }
     ...
     */
    public StringBuilder(final int initialCapacity) {
        super();
    ...
    public StringBuilder(final String str) {
        this(StringUtil.length(str) + CAPACITY);
        if (str != null) {
            append(str);
        }
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder append(final char[] chars) {
        if (chars == null) {
            return appendNull();
        }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder append(final char[] chars, final int startIndex, final int length) {
        if (chars == null) {
            return appendNull();
        }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder append(final CharBuffer str) {
        return append(str, 0, StringUtil.length(str));
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder append(final CharBuffer buf, final int startIndex, final int length) {
        if (buf == null) {
            return appendNull();
        }
        if (buf.hasArray()) {
     ...
     */
    @Override
    public StringBuilder append(final CharSequence seq) {
        if (seq == null) {
            return appendNull();
        }
     ...
     */
    @Override
    public StringBuilder append(final CharSequence seq, final int startIndex, final int endIndex) {
        if (seq == null) {
            return appendNull();
        }
        if (endIndex <= 0) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder append(final String str, final int startIndex, final int length) {
        if (str == null) {
            return appendNull();
        }
     ...
     */
    public StringBuilder append(final String format, final Object... objs) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder append(final StringBuffer str) {
        return append(str, 0, StringUtil.length(str));
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder append(final StringBuffer str, final int startIndex, final int length) {
        if (str == null) {
            return appendNull();
        }
        if (startIndex < 0 || startIndex > str.length()) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder append(final java.lang.StringBuilder str) {
        return append(str, 0, StringUtil.length(str));
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder append(final java.lang.StringBuilder str, final int startIndex, final int length) {
        if (str == null) {
            return appendNull();
        }
        if (startIndex < 0 || startIndex > str.length()) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder append(final StringBuilder str) {
        return append(str, 0, StringUtil.length(str));
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder append(final StringBuilder str, final int startIndex, final int length) {
        if (str == null) {
            return appendNull();
        }
        if (startIndex < 0 || startIndex > str.length()) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendAll(final Iterable<?> iterable) {
        if (iterable != null) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendAll(final Iterator<?> it) {
        if (it != null) {
            while (it.hasNext()) {
                append(it.next());
            }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendFixedWidthPadLeft(final int value, final int width, final char padChar) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendFixedWidthPadLeft(final Object obj, final int width, final char padChar) {
        if (width > 0) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendFixedWidthPadRight(final int value, final int width, final char padChar) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendFixedWidthPadRight(final Object obj, final int width, final char padChar) {
        if (width > 0) {
            ensureCapacity(size + width);
            String str = obj == null ? getNullText() : obj.toString();
            if (str == null) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final boolean value) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final char ch) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final char[] chars) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final char[] chars, final int startIndex, final int length) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final double value) {
        return append(value).appendNewLine();
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final float value) {
        return append(value).appendNewLine();
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final int value) {
        return append(value).appendNewLine();
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final long value) {
        return append(value).appendNewLine();
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final Object obj) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final String str) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final String str, final int startIndex, final int length) {
     ...
     * @see String#format(String, Object...)
     */
    public StringBuilder appendln(final String format, final Object... objs) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final StringBuffer str) {
        return append(str).appendNewLine();
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final StringBuffer str, final int startIndex, final int length) {
        return append(str, startIndex, length).appendNewLine();
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final java.lang.StringBuilder str) {
        return append(str).appendNewLine();
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final java.lang.StringBuilder str, final int startIndex, final int length) {
        return append(str, startIndex, length).appendNewLine();
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final StringBuilder str) {
        return append(str).appendNewLine();
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendln(final StringBuilder str, final int startIndex, final int length) {
        return append(str, startIndex, length).appendNewLine();
    }
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendPadding(final int length, final char padChar) {
        if (length >= 0) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendSeparator(final char separator) {
        if (isNotEmpty()) {
            append(separator);
        }
        return this;
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendSeparator(final char standard, final char defaultIfEmpty) {
        if (isEmpty()) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendSeparator(final char separator, final int loopIndex) {
        if (loopIndex > 0) {
            append(separator);
        }
        return this;
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendSeparator(final String separator) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendSeparator(final String separator, final int loopIndex) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendSeparator(final String standard, final String defaultIfEmpty) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendWithSeparators(final Iterable<?> iterable, final String separator) {
        if (iterable != null) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendWithSeparators(final Iterator<?> it, final String separator) {
        if (it != null) {
            final String sep = Objects.toString(separator, StringUtil.EMPTY);
            while (it.hasNext()) {
                append(it.next());
     ...
     * @return this, to enable chaining
     */
    public StringBuilder appendWithSeparators(final Object[] array, final String separator) {
        if (array != null && array.length > 0) {
            final String sep = Objects.toString(separator, StringUtil.EMPTY);
            append(array[0]);
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public StringBuilder delete(final int startIndex, final int endIndex) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder deleteAll(final char ch) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder deleteAll(final String str) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder deleteFirst(final char ch) {
        for (int i = 0; i < size; i++) {
            if (buffer[i] == ch) {
                deleteImpl(i, i + 1, 1);
                break;
     ...
     * @return this, to enable chaining
     */
    public StringBuilder deleteFirst(final String str) {
        final int len = str == null ? 0 : str.length();
        if (len > 0) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder ensureCapacity(final int capacity) {
    ...
    public boolean equals(final Object obj) {
        return obj instanceof StringBuilder && equals((StringBuilder) obj);
    }
     ...
     * @return true if the builders contain the same characters in the same order
     */
    public boolean equals(final StringBuilder other) {
     ...
     * @return true if the builders contain the same characters in the same order
     */
    public boolean equalsIgnoreCase(final StringBuilder other) {
        if (this == other) {
            return true;
        }
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public StringBuilder insert(final int index, final boolean value) {
        validateIndex(index);
        if (value) {
            ensureCapacity(size + TRUE_STRING_SIZE);
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public StringBuilder insert(final int index, final char value) {
        validateIndex(index);
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public StringBuilder insert(final int index, final char[] chars) {
        validateIndex(index);
        if (chars == null) {
     ...
     * @throws IndexOutOfBoundsException if any index is invalid
     */
    public StringBuilder insert(final int index, final char[] chars, final int offset, final int length) {
        validateIndex(index);
        if (chars == null) {
            return insert(index, nullText);
        }
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public StringBuilder insert(final int index, final double value) {
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public StringBuilder insert(final int index, final float value) {
        return insert(index, String.valueOf(value));
    }
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public StringBuilder insert(final int index, final int value) {
        return insert(index, String.valueOf(value));
    }
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public StringBuilder insert(final int index, final long value) {
        return insert(index, String.valueOf(value));
    }
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public StringBuilder insert(final int index, final Object obj) {
        if (obj == null) {
            return insert(index, nullText);
        }
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public StringBuilder insert(final int index, String str) {
        validateIndex(index);
        if (str == null) {
            str = nullText;
        }
     ...
     * @throws IndexOutOfBoundsException if the index is invalid
     */
    public StringBuilder replace(final int startIndex, int endIndex, final String replaceStr) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder replaceAll(final char search, final char replace) {
        if (search != replace) {
            for (int i = 0; i < size; i++) {
                if (buffer[i] == search) {
                    buffer[i] = replace;
     ...
     * @return this, to enable chaining
     */
    public StringBuilder replaceAll(final String searchStr, final String replaceStr) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder replaceFirst(final char search, final char replace) {
        if (search != replace) {
            for (int i = 0; i < size; i++) {
                if (buffer[i] == search) {
                    buffer[i] = replace;
     ...
     * @return this, to enable chaining
     */
    public StringBuilder replaceFirst(final String searchStr, final String replaceStr) {
        final int searchLen = searchStr == null ? 0 : searchStr.length();
        if (searchLen > 0) {
     ...
     * @since 1.9
     */
    public StringBuilder set(final CharSequence str) {
        clear();
        append(str);
        return this;
    }
     ...
     */
    public StringBuilder setLength(final int length) {
        if (length < 0) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder setNewLineText(final String newLine) {
     ...
     * @return this, to enable chaining
     */
    public StringBuilder setNullText(String nullText) {
    ...
    public char[] toCharArray() {
        return size == 0 ? ArrayUtil.EMPTY_CHAR_ARRAY : Arrays.copyOf(buffer, size);
    }
    ...
    public char[] toCharArray(final int startIndex, int endIndex) {
        ...
        return len == 0 ? ArrayUtil.EMPTY_CHAR_ARRAY : Arrays.copyOfRange(buffer, startIndex, endIndex);
    }
