...
public class HashCodeBuilder implements Builder<Integer> {
    ...
    public HashCodeBuilder(final int initialOddNumber, final int multiplierOddNumber) {
        Preconditions.checkArgument(initialOddNumber % 2 != 0, "HashCodeBuilder requires an odd initial value");
        Preconditions.checkArgument(multiplierOddNumber % 2 != 0, "HashCodeBuilder requires an odd multiplier");
