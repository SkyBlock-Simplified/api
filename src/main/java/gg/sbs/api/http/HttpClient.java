...
public class HttpClient {
	...
	public static HttpResponse get(URL url, int timeout, Proxy proxy, List<HttpHeader> headers) throws HttpConnectionException {
		...
		} catch (HttpConnectionException htcException) {
			throw htcException;
		} catch (SocketException socException) {
			throw new HttpConnectionException(HttpStatus.SOCKET_ERROR, socException);
		} catch (IOException ioException) {
			throw new HttpConnectionException(HttpStatus.IO_ERROR, ioException);
		} catch (Exception ex) {
