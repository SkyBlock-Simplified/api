...
import dev.sbs.api.data.sql.model.formats.FormatRepository;
import dev.sbs.api.data.sql.model.items.ItemRepository;
import dev.sbs.api.data.sql.model.minions.MinionRepository;
import dev.sbs.api.data.sql.model.pets.PetRepository;
...
import dev.sbs.api.data.sql.model.accessories.AccessoryRepository;
import dev.sbs.api.data.sql.model.accessoryfamilies.AccessoryFamilyRepository;
...
import dev.sbs.api.data.sql.model.enchantments.EnchantmentRepository;
import dev.sbs.api.data.sql.model.fairysouls.FairySoulRepository;
import dev.sbs.api.data.sql.model.itemtypes.ItemTypeRepository;
import dev.sbs.api.data.sql.model.locationareas.LocationAreaRepository;
import dev.sbs.api.data.sql.model.locations.LocationRepository;
import dev.sbs.api.data.sql.model.minionitems.MinionItemRepository;
import dev.sbs.api.data.sql.model.miniontiers.MinionTierRepository;
import dev.sbs.api.data.sql.model.miniontierupgrades.MinionTierUpgradeRepository;
