...
import dev.sbs.api.data.model.discord.guild_data.guild_application_entries.GuildApplicationEntrySqlRepository;
import dev.sbs.api.data.model.discord.guild_data.guild_application_requirements.GuildApplicationRequirementSqlRepository;
import dev.sbs.api.data.model.discord.guild_data.guild_application_types.GuildApplicationTypeSqlRepository;
import dev.sbs.api.data.model.discord.guild_data.guild_applications.GuildApplicationSqlRepository;
import dev.sbs.api.data.model.discord.guild_data.guild_command_configs.GuildCommandConfigSqlRepository;
import dev.sbs.api.data.model.discord.guild_data.guild_embeds.GuildEmbedSqlRepository;
import dev.sbs.api.data.model.discord.guild_data.guild_report_types.GuildReportTypeSqlRepository;
import dev.sbs.api.data.model.discord.guild_data.guild_reports.GuildReportSqlRepository;
import dev.sbs.api.data.model.discord.guild_data.guild_reputation.GuildReputationSqlRepository;
import dev.sbs.api.data.model.discord.guild_data.guild_reputation_types.GuildReputationTypeSqlRepository;
import dev.sbs.api.data.model.discord.guild_data.guild_skyblock_events.GuildSkyBlockEventSqlRepository;
import dev.sbs.api.data.model.discord.guild_data.guilds.GuildSqlRepository;
...
import dev.sbs.api.data.model.skyblock.accessory_data.accessory_enrichments.AccessoryEnrichmentSqlRepository;
import dev.sbs.api.data.model.skyblock.accessory_data.accessory_families.AccessoryFamilySqlRepository;
import dev.sbs.api.data.model.skyblock.accessory_data.accessory_powers.AccessoryPowerSqlRepository;
...
import dev.sbs.api.data.model.skyblock.bonus_data.bonus_armor_sets.BonusArmorSetSqlRepository;
import dev.sbs.api.data.model.skyblock.bonus_data.bonus_enchantment_stats.BonusEnchantmentStatSqlRepository;
import dev.sbs.api.data.model.skyblock.bonus_data.bonus_item_stats.BonusItemStatSqlRepository;
import dev.sbs.api.data.model.skyblock.bonus_data.bonus_pet_ability_stats.BonusPetAbilityStatSqlRepository;
import dev.sbs.api.data.model.skyblock.bonus_data.bonus_reforge_stats.BonusReforgeStatSqlRepository;
...
import dev.sbs.api.data.model.skyblock.craftingtable_data.craftingtable_recipe_slots.CraftingTableRecipeSlotSqlRepository;
import dev.sbs.api.data.model.skyblock.craftingtable_data.craftingtable_recipes.CraftingTableRecipeSqlRepository;
import dev.sbs.api.data.model.skyblock.craftingtable_data.craftingtable_slots.CraftingTableSlotSqlRepository;
import dev.sbs.api.data.model.skyblock.dungeon_data.dungeon_bosses.DungeonBossSqlRepository;
import dev.sbs.api.data.model.skyblock.dungeon_data.dungeon_classes.DungeonClassSqlRepository;
import dev.sbs.api.data.model.skyblock.dungeon_data.dungeon_fairy_souls.DungeonFairySoulSqlRepository;
import dev.sbs.api.data.model.skyblock.dungeon_data.dungeon_floor_sizes.DungeonFloorSizeSqlRepository;
import dev.sbs.api.data.model.skyblock.dungeon_data.dungeon_floors.DungeonFloorSqlRepository;
import dev.sbs.api.data.model.skyblock.dungeon_data.dungeon_levels.DungeonLevelSqlRepository;
import dev.sbs.api.data.model.skyblock.dungeon_data.dungeons.DungeonSqlRepository;
import dev.sbs.api.data.model.skyblock.enchantment_data.enchantment_families.EnchantmentFamilySqlRepository;
import dev.sbs.api.data.model.skyblock.enchantment_data.enchantment_stats.EnchantmentStatSqlRepository;
...
import dev.sbs.api.data.model.skyblock.gemstone_data.gemstone_types.GemstoneTypeSqlRepository;
import dev.sbs.api.data.model.skyblock.gemstone_data.gemstones.GemstoneSqlRepository;
...
import dev.sbs.api.data.model.skyblock.location_data.location_areas.LocationAreaSqlRepository;
import dev.sbs.api.data.model.skyblock.location_data.location_remotes.LocationRemoteSqlRepository;
import dev.sbs.api.data.model.skyblock.location_data.locations.LocationSqlRepository;
...
import dev.sbs.api.data.model.skyblock.minion_data.minion_items.MinionItemSqlRepository;
import dev.sbs.api.data.model.skyblock.minion_data.minion_tier_upgrades.MinionTierUpgradeSqlRepository;
import dev.sbs.api.data.model.skyblock.minion_data.minion_tiers.MinionTierSqlRepository;
import dev.sbs.api.data.model.skyblock.minion_data.minion_uniques.MinionUniqueSqlRepository;
...
import dev.sbs.api.data.model.skyblock.pet_data.pet_abilities.PetAbilitySqlRepository;
import dev.sbs.api.data.model.skyblock.pet_data.pet_ability_stats.PetAbilityStatSqlRepository;
import dev.sbs.api.data.model.skyblock.pet_data.pet_items.PetItemSqlRepository;
import dev.sbs.api.data.model.skyblock.pet_data.pet_levels.PetLevelSqlRepository;
import dev.sbs.api.data.model.skyblock.pet_data.pet_scores.PetScoreSqlRepository;
import dev.sbs.api.data.model.skyblock.pet_data.pet_stats.PetStatSqlRepository;
import dev.sbs.api.data.model.skyblock.pet_data.pet_types.PetTypeSqlRepository;
import dev.sbs.api.data.model.skyblock.pet_data.pets.PetSqlRepository;
import dev.sbs.api.data.model.skyblock.potion_data.potion_brew_buffs.PotionBrewBuffSqlRepository;
import dev.sbs.api.data.model.skyblock.potion_data.potion_brews.PotionBrewSqlRepository;
import dev.sbs.api.data.model.skyblock.potion_data.potion_group_items.PotionGroupItemSqlRepository;
import dev.sbs.api.data.model.skyblock.potion_data.potion_groups.PotionGroupSqlRepository;
import dev.sbs.api.data.model.skyblock.potion_data.potion_mixins.PotionMixinSqlRepository;
import dev.sbs.api.data.model.skyblock.potion_data.potion_tiers.PotionTierSqlRepository;
import dev.sbs.api.data.model.skyblock.potion_data.potions.PotionSqlRepository;
...
import dev.sbs.api.data.model.skyblock.reforge_data.reforge_conditions.ReforgeConditionSqlRepository;
import dev.sbs.api.data.model.skyblock.reforge_data.reforge_stats.ReforgeStatSqlRepository;
import dev.sbs.api.data.model.skyblock.reforge_data.reforges.ReforgeSqlRepository;
...
import dev.sbs.api.data.model.skyblock.shop_data.shop_bit_enchanted_books.ShopBitEnchantedBookSqlRepository;
import dev.sbs.api.data.model.skyblock.shop_data.shop_bit_item_craftables.ShopBitItemCraftableSqlRepository;
import dev.sbs.api.data.model.skyblock.shop_data.shop_bit_items.ShopBitItemSqlRepository;
import dev.sbs.api.data.model.skyblock.shop_data.shop_bit_types.ShopBitTypeSqlRepository;
import dev.sbs.api.data.model.skyblock.shop_data.shop_profile_upgrades.ShopProfileUpgradeSqlRepository;
