package dev.sbs.api.client.impl.hypixel.request;

import dev.sbs.api.client.impl.hypixel.response.hypixel.HypixelCountsResponse;
...
import dev.sbs.api.client.impl.hypixel.response.hypixel.HypixelPunishmentStatsResponse;
import dev.sbs.api.client.impl.hypixel.response.hypixel.HypixelStatusResponse;
import dev.sbs.api.client.impl.hypixel.response.resource.ResourceCollectionsResponse;
import dev.sbs.api.client.impl.hypixel.response.resource.ResourceElectionResponse;
...
import dev.sbs.api.client.impl.hypixel.response.skyblock.SkyBlockAuctionResponse;
...
import dev.sbs.api.client.impl.hypixel.response.skyblock.SkyBlockFireSaleResponse;
import dev.sbs.api.client.impl.hypixel.response.skyblock.SkyBlockMuseumResponse;
import dev.sbs.api.client.impl.hypixel.response.skyblock.SkyBlockNewsResponse;
