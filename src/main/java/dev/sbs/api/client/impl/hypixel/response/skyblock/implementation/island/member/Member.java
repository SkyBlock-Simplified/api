package dev.sbs.api.client.impl.hypixel.response.skyblock.implementation.island.member;

import com.google.gson.annotations.SerializedName;
import dev.sbs.api.client.impl.hypixel.response.skyblock.implementation.SkyBlockDate;
import dev.sbs.api.client.impl.hypixel.response.skyblock.implementation.island.*;
import dev.sbs.api.client.impl.hypixel.response.skyblock.implementation.island.accessories.AccessoryBag;
import dev.sbs.api.client.impl.hypixel.response.skyblock.implementation.island.bestiary.Bestiary;
import dev.sbs.api.client.impl.hypixel.response.skyblock.implementation.island.crimson_isle.CrimsonIsle;
import dev.sbs.api.client.impl.hypixel.response.skyblock.implementation.island.crimson_isle.TrophyFish;
import dev.sbs.api.client.impl.hypixel.response.skyblock.implementation.island.dungeon.DungeonData;
