...
public class ResourceItemsResponse {
    ...
    @Getter
    private ConcurrentList<Item> items;
    ...
    public static class Item {
        ...
        @Getter
        private ConcurrentMap<String, List<Integer>> tieredStats;
        ...
        @Getter
        private ConcurrentMap<String, Integer> enchantments;
        @Getter
    ...
    public static class ItemEssence {
        ...
        @Getter
        private ConcurrentList<Integer> costs;
