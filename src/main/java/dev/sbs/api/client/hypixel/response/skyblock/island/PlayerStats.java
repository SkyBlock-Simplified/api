    ...
    PlayerStats(SkyBlockIsland.Member member) {
        ...
        SimplifiedApi.getRepositoryOf(DungeonModel.class)
            ...
            .forEach(dungeonModel -> member.getDungeons()
                ...
                .ifPresent(dungeon -> expressionVariables.put(FormatUtil.format("DUNGEON_LEVEL_{0}", dungeonModel.getKey()), (double) dungeon.getLevel())));
            ...
            accessoryTagStatModels.forEach((accessoryModel, itemTag) -> {
                ...
                SimplifiedApi.getRepositoryOf(RarityModel.class)
                    ...
                    .ifPresent(rarityModel -> {
                        ...
                        // Load Stats
                        accessoryModel.getEffects().forEach((key, value) -> {
                            MutableDouble statValue = new MutableDouble(value);

                            statRepository.findFirst(StatModel::getKey, key)
                                .ifPresent(statModel -> {
                                    // Handle Bonus
                                    optionalBonusItemStatModel.ifPresent(bonusItemStatModel -> {
