package dev.sbs.api.util.translate;
...
public final class CsvTranslators {
    ...
    private static final char[] CSV_SEARCH_CHARS =
            new char[] {CSV_DELIMITER, CSV_QUOTE, CharUtil.CR, CharUtil.LF};
    ...
    public static class CsvEscaper extends SinglePassTranslator {
        ...
        void translateWhole(final CharSequence input, final Writer out) throws IOException {
            ...
            if (StringUtil.containsNone(inputSting, CSV_SEARCH_CHARS)) {
                ...
                // input needs quoting
                out.write(CSV_QUOTE);
                out.write(StringUtil.replace(inputSting, CSV_QUOTE_STR, CSV_ESCAPED_QUOTE_STR));
                out.write(CSV_QUOTE);
            }
        }
    }
    ...
    public static class CsvUnescaper extends SinglePassTranslator {
        ...
        void translateWhole(final CharSequence input, final Writer out) throws IOException {
            ...
            if (StringUtil.containsAny(quoteless, CSV_SEARCH_CHARS)) {
                ...
                out.write(StringUtil.replace(quoteless, CSV_ESCAPED_QUOTE_STR, CSV_QUOTE_STR));
            } else {
                out.write(quoteless);
            }
        }
