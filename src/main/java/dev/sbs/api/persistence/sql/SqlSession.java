...
@Getter
public final class SqlSession extends Session<SqlModel> {
    ...
    public void transaction(@NotNull Consumer<org.hibernate.Session> consumer) throws SqlException {
        this.with(session -> {
    ...
    public <R> R transaction(@NotNull Function<org.hibernate.Session, R> function) throws SqlException {
    ...
    public void with(@NotNull Consumer<org.hibernate.Session> consumer) throws SqlException {
        try {
