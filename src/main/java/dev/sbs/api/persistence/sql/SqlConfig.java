...
import dev.sbs.api.persistence.json.JsonConfig;
import dev.sbs.api.persistence.sql.driver.MariaDBDriver;
import dev.sbs.api.persistence.sql.driver.SqlDriver;
...
public final class SqlConfig implements SessionConfig<SqlModel> {
    ...
    @Override
    public @NotNull Session<SqlModel> createSession() {
