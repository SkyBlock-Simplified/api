...
public enum MinecraftFont implements Font {
    ...
    MinecraftFont(@ResourcePath(base = "minecraft/fonts") @NotNull String resourcePath, @NotNull Style style, float size) {
        this(Font.initFont(resourcePath, size), style, size);
    }
