...
public final class InvalidBuilderException extends SimplifiedException {
    ...
    private InvalidBuilderException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace, ConcurrentList<Triple<String, String, Boolean>> fields) {
