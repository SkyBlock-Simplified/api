...
public final class RegisteredBuilderException extends SimplifiedException {
    ...
    private RegisteredBuilderException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace, ConcurrentList<Triple<String, String, Boolean>> fields) {
