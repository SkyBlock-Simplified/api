...
public class GemstoneSqlModel implements GemstoneModel, SqlModel {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GemstoneSqlModel)) return false;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(this.getId()).append(this.getKey()).append(this.getName()).append(this.getStat()).append(this.getUpdatedAt()).build();
    }
